		...
		$.ajax({
	    	...
	    	success: function(result) {
		    	...
		    	if(result.result == "success") {
		    		...
		    		utils.showTreeView(containerDivId, result.value);
		    	}
	    	}
	    });
	};
	...
	var showFeatureToTestCasesCytoscape = function(containerDivId) {
		$.ajax({
	    	...
	    	success: function(result) {
		    	...
		    	if(result.result == "success") {
		    		console.log(result.value)
		    		var cy = utils.showDataInCytoscape(containerDivId, result.value, "breadthfirst")
		    		$("#test").click(function(){
...
//			console.log(targetDivId);
	...
	return {
		...
		toHTML: function(nodeType, nodeGraphId, cytoscapeDiv){
			toHTML(nodeType, nodeGraphId, cytoscapeDiv);
		},
		itemOnclick: function (target) {
			itemOnclick(target)
		}
	}
});
