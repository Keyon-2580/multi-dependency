...
public interface FunctionReturnTypeRepository extends Neo4jRepository<FunctionReturnType, Long> {
	...
	@Query("MATCH result=(function:Function)-[r:" + RelationType.str_FUNCTION_RETURN_TYPE + "]->(type:Type) with function,type,result match (project:Project)-[r2:" + RelationType.str_CONTAIN + "*3..4]->(type) where id(project)={projectId} RETURN result")
