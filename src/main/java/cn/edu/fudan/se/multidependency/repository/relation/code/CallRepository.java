...
public interface CallRepository extends Neo4jRepository<Call, Long> {
	...
	@Query("MATCH result=(function1:Function)-[r:" + RelationType.str_CALL + "]->(function2:Function) with function1,function2,result match (project:Project)-[r2:" + RelationType.str_CONTAIN + "*3..5]->(function1) where id(project)=$projectId RETURN result")
	 ...
	 * @return
	 */
	@Query("MATCH result=(function1:Function)-[r:" + RelationType.str_CALL + "]->(function2:Function) where id(function1)=$functionId RETURN result")
	 ...
	 * @return
	 */
	@Query("MATCH result=(function1:Function)-[r:" + RelationType.str_CALL + "]->(function2:Function) where id(function2)=$functionId RETURN result")
...
//	Object queryTest(@Param("fileId") long fileId);
	...
	@Query("MATCH result=(type:Type)-[r:" + RelationType.str_CALL + "]->(function:Function) with type,function,result match (project:Project)-[r2:" + RelationType.str_CONTAIN + "*3..4]->(type) where id(project)=$projectId RETURN result")
