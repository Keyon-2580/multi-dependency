...
public class GitAnalyseService {
    ...
    Map<String, Project> projectsCache = null;
    ...
    public Map<String, Project> findAllProjects() {
        if (projectsCache == null) {
            ...
            projects.forEach(project -> projectsCache.put(project.getName(), project));
        }
    ...
    public Map<Developer, Map<Project, Integer>> calCntOfDevUpdPro() {
        ...
        for (Commit commit : findAllCommits()) {
            ...
            for (ProjectFile file : files) {
                ...
                Project project = findAllProjects().get(projectName);
