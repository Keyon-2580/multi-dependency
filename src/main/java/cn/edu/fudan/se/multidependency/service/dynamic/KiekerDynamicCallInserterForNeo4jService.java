...
import cn.edu.fudan.se.multidependency.utils.DynamicUtil.DynamicFunctionCallFromKieker;
...
public class KiekerDynamicCallInserterForNeo4jService extends KiekerDynamicInserterForNeo4jService {
	...
	protected void extractNodesAndRelations() throws Exception {
		...
		Map<String, List<DynamicFunctionCallFromKieker>> allDynamicFunctionFromKiekers = DynamicUtil.readKiekerCallFile(executeFiles);
