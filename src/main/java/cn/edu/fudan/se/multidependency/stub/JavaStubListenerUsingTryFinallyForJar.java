...
public class JavaStubListenerUsingTryFinallyForJar extends JavaStubListenerUsingTryFinally {
	...
	public JavaStubListenerUsingTryFinallyForJar(TokenStream tokens, String projectName, File listenFile,
	...
	public void enterClassBody(ClassBodyContext ctx) {
		...
		if(getMethodContainerName().equals(globalClass)) {
			...
			.append(MULTIPLE_STRING_BUILDER).append(".append(\"{\\\"language\\\" : \\\"java\\\", \").append(\"\\\"time\\\" : \\\"\")\r\n" + 
					...
					"				.append(\"\\\", \\\"traceId\\\" : \\\"\").append(\"default\")\r\n" + 
					"				.append(\"\\\", \\\"spanId\\\" : \\\"\").append(\"default\")\r\n" + 
