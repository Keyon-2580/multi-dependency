...
public interface AggregationCloneRepository extends Neo4jRepository<AggregationClone, Long> {
    ...
    void createAggregationClone(@Param("pck1Id") long pck1Id, @Param("pck2Id") long pck2Id, @Param("parent1Id") long parent1Id, @Param("parent2Id") long parent2Id, @Param("clonePairs") int clonePairs, @Param("allNodesInNode1") int allNodesInNode1, @Param("allNodesInNode2") int allNodesInNode2, @Param("nodesInNode1") int nodesInNode1, @Param("nodesInNode2") int nodesInNode2);
    ...
    List<AggregationClone> findAggregationCloneByParentId(@Param("parent1Id") long parent1Id, @Param("parent2Id") long parent2Id);

    @Query("match p= (p1:Package)-[r:" + RelationType.str_AGGREGATION_CLONE + "]->(p2:Package) where id(p1) = {pck1Id} and id(p2) = {pck2Id} return p")
    AggregationClone findAggregationCloneById(@Param("pck1Id") long pck1Id, @Param("pck2Id") long pck2Id);
